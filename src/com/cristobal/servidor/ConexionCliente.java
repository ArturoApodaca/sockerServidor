...
/**
 * Esta clase gestiona el envio de datos entre el servidor
 * y el cliente al que atiende.
 */
public class ConexionCliente extends Thread implements Observer {
	...
	public ConexionCliente(Socket socket, Chat mensajes) {
    ...
    public void update(Observable o, Object arg) {
        try {
            ...
            System.out.println("Servidor dice a todos: " + arg.toString());
        } catch (IOException ex) {
